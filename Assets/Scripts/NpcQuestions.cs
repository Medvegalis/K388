...
public class NpcQuestions : MonoBehaviour
{
    ...
    async void GenerateQuestions(string snippet)
    {
        ...
        messages.Add(new ChatMessage { Role = "assistant", Content = "This is a snippet from a presentation that has ended, ask a question that is related to the topic of the presentation to the presenter. Question should be in a language the snippet is provided" });
